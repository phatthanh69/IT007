...
int main()
{
    while (1)
    {
        ...
        printf("\t1. Default referenced sequence: 2, 1, 5, 2, 1, 2, 6, 2, 0, 0, 7\n");
        ...
        if (key == 1)
        {
            ...
            input[0] = input[3] = input[5] = input[7] = 2;
            input[1] = input[4] = 1;
            input[2] = 5;
            input[6] = 6;
            input[8] = input[9] = 0;
        ...
        while (1)
        {
            ...
            if (key == 4)
                break;
            if (key == 1)
                table = FIFO(input, size, frames);
            if (key == 2)
                table = OPT(input, size, frames);
            if (key == 3)
                table = LRU(input, size, frames);
